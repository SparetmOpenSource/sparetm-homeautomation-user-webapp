...
import Error from '../../../../../CommonComponents/ErrorPage/ErrorPage';
...
export const Home = ({ data, darkTheme }: any) => {
    ...
    const filteredQueue = queue
        ...
        .sort((a: any, b: any) => {
            const isCurrentA = data?.data?.body?.item?.id === a.id;
            const isCurrentB = data?.data?.body?.item?.id === b.id;
        ...
        <div className="spotify-expand-content-home">
            ...
            >
                ...
                >
                                    ...
                                    <Confirmation
                                        ...
                                        btnOkFn={() =>
                                            addToAlbumMutation.mutate({
                                                id: data?.data?.body?.item?.album?.id,
                                            })
                                        }
                                        btnCancelFn={() =>
                                            toggleBackDropClose(
                    ...
                    <section>
                        <p style={{ color: color.success }}>
                            {data ? data.data.body.item?.album?.total_tracks : '0'}{' '}
                            <span style={{ color: color.text }}>
                                songs in album
                            </span>
                        </p>

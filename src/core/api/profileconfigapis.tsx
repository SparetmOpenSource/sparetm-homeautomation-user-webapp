...
export const useCountryList = (headerOptions: any, darkTheme: any, options: any = {}) => {
    return useReactQuery_Get(
...
export const useStateList = (headerOptions: any, countryIso: any, darkTheme: any, options: any = {}) => {
    return useReactQuery_Get(
...
export const useCityList = (headerOptions: any, countryIso: any, stateIso: any, darkTheme: any, options: any = {}) => {
    return useReactQuery_Get(
...
export const useAddProfile = (admin: any, darkTheme: boolean, onSuccess: any) => {

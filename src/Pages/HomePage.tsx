  ...
  return (
    <div className='home'>
      <section className='home-opening'>
           <div className='home-opening-logo'><GiCableStayedBridge/>&nbsp;&nbsp;{ AppName }</div>
      ...
      <section className='home-intro'>
        <div>
         ...
         <p>so we thought of creating a system that rewards its members for doing good and being trustworthy. this way, trust as a virtue becomes something to aspire to, just the way it should be. then we went one step ahead: we built it. we know we are on the right track because here you are.</p>
            <p>if you make it to OpenBridge, congratulations and welcome. we have a lot of things planned for you.</p>
            </section>
        </div>
        <div>
          <section>
          ...
          <section>
            <MdOutlineWifiProtectedSetup fontSize={50} color='green'/>
            <h1>Sign In and create your profile</h1>
            <p>Customize the design of your shop from over thousands of themes. No design experience or programming skills required.</p>
          </section>
        </div>
      ...
      <section className='home-contact'>
        ...
        <div>
          <section>      <ul>
                            <li>
              <p
                onClick={()=>displayToastify('hello shubham',TOASTIFYCOLOR.DARK,TOASTIFYSTATE.INFO)} 
                                    // onClick={() =>
                                    //     openPrivacyModel
                                    //         ? closePrivacy()
                                    //         : openPrivacy()

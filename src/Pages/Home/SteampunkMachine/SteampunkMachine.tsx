...
import { gsap, Linear, Elastic, Circ, Power2 } from 'gsap';

interface SteampunkMachineProps {}

const SteampunkMachine: React.FC<SteampunkMachineProps> = () => {
    const gearRef = useRef<SVGPathElement>(null);
    const fanEmptyRef = useRef<SVGPathElement>(null);
    const fanFullRef = useRef<SVGPathElement>(null);
    const bellowsRef = useRef<SVGPathElement>(null);
    const bigLtBaseRef = useRef<SVGPathElement>(null);
    const bigLtBulbRef = useRef<SVGPathElement>(null);
    const smLtBaseRef = useRef<SVGPathElement>(null);
    const smLtBulbRef = useRef<SVGPathElement>(null);
    const filamentRef = useRef<SVGPolygonElement>(null);
    const faucetRef = useRef<SVGPolygonElement>(null);
    const smGlowRef = useRef<SVGCircleElement>(null);
    const bigGlowRef = useRef<SVGEllipseElement>(null);
    const firefly1Ref = useRef<SVGGElement>(null);
    const firefly2Ref = useRef<SVGGElement>(null);
    const firefly3Ref = useRef<SVGGElement>(null);
    ...
    useEffect(() => {
        if (
            ...
            !fanFullRef.current ||
            !bellowsRef.current ||
            !bigLtBaseRef.current ||
            !bigLtBulbRef.current ||
            !smLtBaseRef.current ||
            !smLtBulbRef.current ||
            !filamentRef.current ||
            !faucetRef.current ||
        ...
        tl.add('start')
            ...
            .to(
                ...
                {
                    duration: 2.5,
                    fill: 'rgba(255, 255, 180, 0.4)', // brighter glow
            ...
            .to(
                ...
                {
                    duration: 2,
                    fill: 'rgb(255, 255, 180)', // brighter yellow
                    ease: 'slowMo.ease.config(0.7, 0.7, false)',
                },
                'start+=3.5',
            )
    ...
    return (
        ...
        .ff-glow-unique {
          animation: stutter-unique 4s linear infinite;
        }

        @keyframes stutter-unique {
          20% { opacity: 0.3; }
          30% { opacity: 1; }
          40% { opacity: 0.4; }
          50% { opacity: 0.7; }
        ...
        .s0 { stop-color:#FFFFFF; }
        .s1 { stop-color:#FCEE91; stop-opacity:0; }
        .s2 { stop-color:#FEFBE4; stop-opacity:0.8; }
        .s3 { stop-color:#FDF5C0; stop-opacity:0.6; }
        .s4 { stop-color:#FDF1A6; stop-opacity:0.4; }
        .s5 { stop-color:#FCEF97; stop-opacity:0.2; }
      `}</style>
            <div className="steampunk-unique-container">
                <svg
                    version="1.1"
                    x="0"
                    y="0"
                ...
                >
                    <g id="Layer_1">
                        ...
                        <path
                            fill="none"
                            d="M181.8 150.5c-8.5 0-15.4 7-15.4 15.5 0 8.6 6.9 15.5 15.4 15.5 8.5 0 15.4-7 15.4-15.5C197.2 157.4 190.3 150.5 181.8 150.5z"
                        />
                        <path
                            fill="#161216"
                        ...
                        <path
                            fill="#161216"
                            d="M369 67h10.8c7.4 0 13.3-5.2 13.3-12.5 0-7.3-6-12.5-13.3-12.5h-76.8c-7.4 0-13.3 5.2-13.3 12.5 0 7.3 6 12.5 13.3 12.5H315v12c1 0 7 0 9 0V67h27.9 -11.8 0.1 0.1 1.9 7.1H358v21h11V67zM302.9 64.4c-5.6 0-10.2-4.5-10.2-10 0-5.5 4.6-10 10.2-10 5.6 0 10.2 4.5 10.2 10C313.1 59.9 308.6 64.4 302.9 64.4z"
                        />
                        <rect
                            x="16"
                            y="277"
                        ...
                        <path
                            fill="#161216"
                            d="M115 317H48c-17.2 0-29.8-12.6-30.1-29.8L17.9 286h10.3l0 1.1C28.4 299.3 36.6 308 48 308H115V317zM20 288c0.7 15.2 12.4 26 28 26H114v-4H48c-12.4 0-21.2-9.8-21.8-22H20z"
                        />
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                        ...
                        <path
                            fill="#161216"
                            d="M348.4 291.8c-9.2 0-16.7 7.4-16.7 16.5v40.9H321.7v-40.9c0-14.6 12-26.4 26.8-26.4h12.1c0 2.2 0 7.6 0 9.9H348.4z"
                        />
                        <path
                            fill="none"
                            d="M438.1 279.1c-0.6 0.3-1.3 0.5-2.1 0.5h-2.7c-0.6 0-1.1 0.5-1.1 1.1 0 0.6 0 13.7 0 14.4 0 0.6 0.5 1.1 1.1 1.1h2.7c0.8 0 1.5 0.2 2.1 0.5l6.3 3.6c2.2 1.3 4.7 2 7.4 2 8.1 0 14.6-6.5 14.6-14.4 0-8-6.5-14.4-14.6-14.4 -2.7 0-5.2 0.7-7.4 2L438.1 279.1z"
                        />
                        <path
                            fill="none"
                            d="M362.4 289.4h45.3v7.4h7.9v2.4h-7.9v0.8h-2v-0.9c-4.3-0.6-7.8-3.6-9.1-7.6h-32.9"
                        />
                        <path
                            fill="none"
                            d="M359.5 284.4h37c1.3-4 4.9-7 9.1-7.6v-0.9h2v0.7h7.9v2.4h-7.9v7.4h-47"
                        />
                        <path
                            fill="none"
                            d="M416.6 276.7h12.8v3.2l-1 0c-0.3 0-0.6 0.3-0.6 0.6 0 0.3-0.3 0.6-0.6 0.6 -0.3 0-0.6-0.2-0.6-0.6 0-0.3-0.3-0.6-0.6-0.6 -0.3 0-0.6 0.3-0.6 0.6 0 0.3-0.3 0.6-0.6 0.6 -0.3 0-0.6-0.2-0.6-0.6 0-0.3-0.3-0.6-0.6-0.6 -0.3 0-0.6 0.3-0.6 0.6 0 0.2-0.1 0.3-0.2 0.4l-1 1h-6.6v-1.8h3.4V276.7z"
                        />
                        <rect
                            x="408.6"
                            y="280"
                        ...
                        <path
                            fill="#161216"
                            d="M363.6 291.4h32.9c1.3 4 4.9 7 9.1 7.6v0.9h2v-0.7h7.9v-2.4h-7.9v-7.4h-45.3"
                        />
                        <path
                            fill="#161216"
                            d="M360.7 286.5h47v-7.4h7.9v-2.4h-7.9v-0.7h-2v0.9c-4.3 0.6-7.8 3.6-9.1 7.6h-37"
                        />
                        <rect
                            x="358"
                            y="153"
                        ...
                        <path
                            fill="#161216"
                            d="M375.1 209.4c0 4.5 3.7 8.1 8.2 8.1h14.3c1.6 0 2.8 1.3 2.8 2.8 0 1.5-1.3 2.8-2.8 2.8h-13.4v-1.3h-1.5v2.2h-15.7v3.5h15.7v2.2h1.5v-1.3h13.4c4.5 0 8.2-3.6 8.2-8.1 0-4.5-3.7-8.1-8.2-8.1h-14.3c-1.6 0-2.8-1.3-2.8-2.8V196.8h-5.3V209.4z"
                        />
                        <rect
                            x="368"
                            y="184"
                        ...
                        <path
                            fill="#161216"
                            d="M257 307v13h-1v3h1.8c1.2 9 7.2 15 14.2 17.4V347h4v-27h-14v-14L260.9 307H257z"
                        />
                        <path
                            fill="#161216"
                            d="M302 307h-7v13h-14v27h4v-6.6c9-2.4 13.8-8.4 15-17.4H302v-1.9l0 0V307z"
                        />
                        <polygon
                            fill="#161216"
                            points="260.9 305.8 262.1 306 262.1 305.8 "
                        />
                        <polygon
                            ref={faucetRef}
                            id="faucet"
                            fill="#161216"
                            points="41.364,259 39.375,259 27,269.621 27,269 21,269 21,269.57 9.606,259 7.429,259 4.877,271.9 20.265,273.822 27.114,274.24 43.866,272.59 	"
                        />
                        <polygon
                            id="screw"
                            fill="#161216"
                            points="26,265 26,263 22,263 22,265 21,265 21,277 27,277 27,265 	"
                        />
                    </g>
                    <g id="Layer_2">
                        <path
                    ...
                    <g id="layer">
                        <path
                            fill="#161216"
                            d="M135.1 141.7c-0.4 0-0.5 0.2-0.8 0.4L132 144.6V161h4v-9h8v-31h-7.5l0 2.5c0 0.8-0.6 1.4-1.4 1.4 -0.8 0-1.4 0.6-1.4 1.4 0 0.8 0.6 1.4 1.4 1.4 0.8 0 1.4 0.6 1.4 1.4 0 0.8-0.6 1.4-1.4 1.4 -0.8 0-1.4 0.6-1.4 1.4 0 0.8 0.6 1.4 1.4 1.4 0.8 0 1.4 0.6 1.4 1.4 0 0.8-0.6 1.4-1.4 1.4 -0.8 0-1.4 0.6-1.4 1.4 0 0.8 0.6 1.4 1.4 1.4C136.5 141.1 135.9 141.7 135.1 141.7z"
                        />
                        <path
                            fill="#161216"
                        ...
                        <path
                            fill="#161216"
                            d="M95 174v-19h-6v19h-2v5h2.1C90.6 189 105 209.3 111 211.4V282h3.3l-1.3-108H95z"
                        />
                        <path
                            fill="#161216"
                            d="M144 155h-6v19h-17.8l-1.3 108H122v-70.6c6-2.1 20.5-22.4 22-32.4H146v-5h-2V155z"
                        />
                        <rect
                            x="97"
                            y="163"
                    ...
                    <g id="little_light">
                        <g ref={smLtBaseRef} id="light-base">
                            <path
                                fill="rgb(38, 31, 38)"
                                d="M432 281.2l-0.5-0.5c0 0 0 0 0 0.1l-3.1 0c-0.3 0-0.6 0.3-0.6 0.6 0 0.3-0.3 0.6-0.6 0.6 -0.3 0-0.6-0.3-0.6-0.6 0-0.3-0.3-0.6-0.6-0.6 -0.3 0-0.6 0.3-0.6 0.6 0 0.3-0.3 0.6-0.6 0.6 -0.3 0-0.6-0.3-0.6-0.6 0-0.3-0.3-0.6-0.6-0.6 -0.3 0-0.6 0.3-0.6 0.6 0 0.3-0.3 0.6-0.6 0.6 -0.3 0-0.6-0.3-0.6-0.6 0-0.3-0.2-0.6-0.6-0.6 -0.3 0-0.6 0.3-0.6 0.6 0 0.2-0.1 0.3-0.2 0.4l-2.4 2.4c-0.2 0-0.3 0.1-0.4 0.2l-2 1.9c-1 0-1.7 0.8-1.7 1.7 0 1 0.8 1.7 1.8 1.7l2 1.9c0.1 0.1 0.2 0.2 0.4 0.2l2.4 2.4c0.1 0.1 0.2 0.2 0.2 0.4 0 0.3 0.3 0.6 0.6 0.6 0.3 0 0.6-0.3 0.6-0.6 0-0.3 0.3-0.6 0.6-0.6 0.3 0 0.6 0.3 0.6 0.6 0 0.3 0.3 0.6 0.6 0.6 0.3 0 0.6-0.3 0.6-0.6 0-0.3 0.3-0.6 0.6-0.6 0.3 0 0.6 0.3 0.6 0.6 0 0.3 0.3 0.6 0.6 0.6 0.3 0 0.6-0.3 0.6-0.6 0-0.3 0.3-0.6 0.6-0.6 0.3 0 0.6 0.3 0.6 0.6 0 0.3 0.3 0.6 0.6 0.6l3.1 0 0.5-0.6C432 292.2 432 283.3 432 281.2z"
                            />
                        </g>
                        <path
                            ref={smLtBulbRef}
                        ...
                        <polygon
                            ...
                            clipRule="evenodd"
                            fill="rgb(38, 31, 38)"
                            points="431.8 285.2 431.8 290.7 442.1 290.7 442.1 289 450.4 289 450.4 292.3 452.1 292.3 452.1 283.5 450.4 283.5 450.4 286.8 442.1 286.8 442.1 285.2 431.8 285.2 "
                        />
                        <radialGradient
                            id="glow_1_"
                            cx="449.1"
                        ...
                        <radialGradient
                            ...
                            cy="60.3047"
                            r="38.0039"
                            gradientTransform="matrix(1.5823 0 0 1.6052 -67.5918 -31.2188)"
                            gradientUnits="userSpaceOnUse"
                        >
                            <stop offset="0" style={{ stopColor: '#FFFFFF' }} />
                            <stop
                                offset="1"
                                style={{ stopColor: '#FCEE91', stopOpacity: 0 }}
                            />
                        </radialGradient>
                        <ellipse
                            ref={bigGlowRef}
                    ...
                    <g id="fireflies">
                        <g ref={firefly3Ref} id="firefly_2_">
                            <radialGradient
                                id="SVGID_1_"
                                cx="94.8"
                                cy="7.2"
                                r="13.6"
                                gradientTransform="matrix(0.2557 -1.381 1.381 0.2557 111.9053 207.6387)"
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop offset="0" stopColor="#FFFFFF" />
                                <stop offset="0.2" className="s2" />
                                <stop offset="0.4" className="s3" />
                                <stop offset="0.6" className="s4" />
                                <stop offset="0.8" className="s5" />
                                <stop offset="1" className="s1" />
                            </radialGradient>
                            <circle
                                className="ff-glow"
                            ...
                            />
                            <ellipse
                                transform="matrix(0.1821 -0.9833 0.9833 0.1821 40.9701 201.7859)"
                                fill="none"
                                stroke="#161216"
                                strokeMiterlimit="10"
                                cx="141.8"
                            ...
                            />
                            <ellipse
                                transform="matrix(-0.2436 -0.9699 0.9699 -0.2436 100.2584 231.4852)"
                                fill="none"
                                stroke="#161216"
                                strokeMiterlimit="10"
                                cx="140.4"
                            ...
                            />
                            <ellipse
                                transform="matrix(-0.3489 -0.9372 0.9372 -0.3489 119.0644 242.3042)"
                                fill="#BFBF8A"
                                cx="143.7"
                                cy="79.8"
                                rx="1.4"
                        ...
                        <g ref={firefly2Ref} id="firefly_1_">
                            <radialGradient
                                id="SVGID_2_"
                                cx="96.7"
                                cy="-35.8"
                                r="13.6"
                                gradientTransform="matrix(-0.7712 -1.1738 -1.1738 0.7712 108.6123 200.6338)"
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop offset="0" stopColor="#FFFFFF" />
                                <stop offset="0.2" className="s2" />
                            ...
                            />
                            <ellipse
                                transform="matrix(-0.5492 -0.8357 0.8357 -0.5492 76.0065 152.5574)"
                                fill="none"
                                stroke="#161216"
                                strokeMiterlimit="10"
                                cx="79.2"
                            ...
                            />
                            <ellipse
                                transform="matrix(-0.1516 -0.9884 0.9884 -0.1516 37.8319 143.6604)"
                                fill="none"
                                stroke="#161216"
                                strokeMiterlimit="10"
                                cx="80.6"
                            ...
                            />
                            <ellipse
                                transform="matrix(-0.0418 -0.9991 0.9991 -0.0418 22.3128 140.9486)"
                                fill="#BFBF8A"
                                cx="78.7"
                                cy="59.8"
                                rx="1.4"
                        ...
                        <g ref={firefly1Ref} id="firefly">
                            <radialGradient
                                id="SVGID_3_"
                                cx="133.7"
                                cy="-0.6"
                                r="13.6"
                                gradientTransform="matrix(0.273 -1.3777 1.3777 0.273 118.4131 222.9336)"
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop offset="0" stopColor="#FFFFFF" />
                                <stop offset="0.2" className="s2" />
                            ...
                            />
                            <ellipse
                                transform="matrix(0.1944 -0.9809 0.9809 0.1944 85.1625 176.121)"
                                fill="none"
                                stroke="#161216"
                                strokeMiterlimit="10"
                                cx="149.8"
                            ...
                            />
                            <ellipse
                                transform="matrix(-0.2314 -0.9729 0.9729 -0.2314 147.1825 189.4322)"
                                fill="none"
                                stroke="#161216"
                                strokeMiterlimit="10"
                                cx="148.4"
                            ...
                            />
                            <ellipse
                                transform="matrix(-0.3372 -0.9414 0.9414 -0.3372 165.4048 195.9743)"
                                fill="#BFBF8A"
                                cx="151.7"
                                cy="39.8"
                                rx="1.4"
...
export default SteampunkMachine;

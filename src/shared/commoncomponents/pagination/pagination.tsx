    ...
    const renderPageNumbers = () => {
        ...
        if (startPage > 1) {
            pages.push(
                <li
                    key={1}
                    className={`spotify-pagination-page-item ${currentPage === 1 ? 'active' : ''
                        }`}
        ...
        for (let i = startPage; i <= endPage; i++) {
            pages.push(
                <li
                    key={i}
                    className={`spotify-pagination-page-item ${currentPage === i ? 'active' : ''
                        }`}
        ...
        if (endPage < totalPages) {
            ...
            pages.push(
                <li
                    key={totalPages}
                    className={`spotify-pagination-page-item ${currentPage === totalPages ? 'active' : ''
                        }`}
    ...
    return (
        <nav>
            <ul className="spotify-pagination">
                <li
                    className={`spotify-pagination-page-item ${currentPage === 1 ? 'disabled' : ''
                        }`}
                >
                    <span
                        className="spotify-pagination-page-link"
                ...
                {renderPageNumbers()}
                <li
                    className={`spotify-pagination-page-item ${currentPage === totalPages ? 'disabled' : ''
                        }`}
                >
                    <span
                        className="spotify-pagination-page-link"

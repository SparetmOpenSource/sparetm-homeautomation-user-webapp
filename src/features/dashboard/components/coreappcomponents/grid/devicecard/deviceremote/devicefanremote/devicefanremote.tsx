...
import { useDeleteDeviceStoreData, useUpdateDeviceFanRemote, useUpdateDeviceStoreData } from '../../../../../../../../core/api/Coreappapis';
...
const DeviceFanRemote: React.FC<DeviceFanRemoteProps> = ({ deviceId, darkTheme }) => {
    ...
    const { mutate } = useUpdateDeviceFanRemote(deviceId, () => {}, onError);

...
const RgbGadgetExpand = ({
    ...
    const { mutate: updateDeviceStoreData } = useUpdateDeviceStoreData(
        id,
        (error: any) => {
            displayToastify(
    ...
    const handleColorSave = useCallback(() => {
        ...
        // Toast and menu change should ideally be in onSuccess of useUpdateDeviceStoreData
        // but currently useUpdateDeviceStoreData doesn't accept onSuccess callback.
        // I should probably update it in coreappapis.tsx if I want better UX.
        // For now I'll just leave it as is or update coreappapis.tsx.
